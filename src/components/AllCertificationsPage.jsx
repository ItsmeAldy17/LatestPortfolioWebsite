...
import { ArrowLeft, Calendar, FileText, ExternalLink, Download, X } from 'lucide-react';
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <Button
                        onClick={() => navigate('/')} // Corrected to navigate to certifications section
                        variant="ghost"
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                        A complete list of my professional certifications in various domains.
                    </p>
                </motion.div>
                        ...
                        return (
                            ...
                            >
                                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 h-full hover:border-emerald-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10">
                                    ...
                                    {/* Title */}
                                    <h3 className="text-lg font-bold mb-2 text-center text-white group-hover:text-emerald-400 transition-colors">
                                        {item.name}
                                    </h3>
